...
async function fetchPortfolio() {
    try {
        ...
        document.getElementById('name').innerText = data.name || "Anna Mmary";
        ...
        document.getElementById('name').innerText = "Anna Mmary"; 
        document.getElementById('profile').innerText = "I am a passionate Data Science student at EASTC... (Failed to sync with live API, showing cached profile)";
    }
}
